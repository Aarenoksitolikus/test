        ...
        <div style="max-width: 400px; margin: 2rem auto; background: #f9f9f9; padding: 2rem; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <form method="post" action="/register">
                ...
                <div style="margin-bottom: 1.5rem;">
                    <label style="display: block; margin-bottom: 0.5rem; font-weight: bold;">Подтвердите пароль:</label>
                    <input type="password" name="confirmPassword" required
                           style="width: 100%; padding: 0.75rem; border: 1px solid #ddd; border-radius: 4px;">
                </div>

                <button type="submit"
                        style="width: 100%; padding: 0.75rem; background: #27ae60; color: white; border: none; border-radius: 4px; cursor: pointer;">
                    Зарегистрироваться
                </button>
            </form>

            <p style="text-align: center; margin-top: 1.5rem;">
                Уже есть аккаунт? <a href="/login" style="color: #3498db;">Войдите</a>
            </p>
        </div>
    </main>
